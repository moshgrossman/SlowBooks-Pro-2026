...
WA_LNI_RATES = {
    "5206": {"total": Decimal("0.0600"), "employee": Decimal("0.0250")},  # Clerical / office
    "6303": {"total": Decimal("0.1400"), "employee": Decimal("0.0600")},  # Outside sales / messengers
    "0101": {"total": Decimal("0.9800"), "employee": Decimal("0.3600")},  # Excavation / earthwork
    "0510": {"total": Decimal("1.1200"), "employee": Decimal("0.4000")},  # Wood-frame construction
    "0540": {"total": Decimal("1.4500"), "employee": Decimal("0.5200")},  # Roof work
    "3909": {"total": Decimal("0.2600"), "employee": Decimal("0.1000")},  # Warehouse / stores
    "7100": {"total": Decimal("0.1100"), "employee": Decimal("0.0450")},  # Restaurant / food service
}
